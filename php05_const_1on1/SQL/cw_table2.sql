...
CREATE TABLE IF NOT EXISTS `cw_table2` (
    `id` int(12) NOT NULL,
...
--
-- テーブルのデータのダンプ `cw_table2`
--

INSERT INTO `cw_table2` (`id`, `name`, `email`, `naiyou`, `indate`, `age`) VALUES
...
--
-- Indexes for table `cw_table2`
--
ALTER TABLE `cw_table2`
 ADD PRIMARY KEY (`id`);
